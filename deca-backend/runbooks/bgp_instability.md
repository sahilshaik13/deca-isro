...
## Plain English
- Lab inject soft-clears BGP toward the core neighbor (`10.1.3.1`).
...
## Mild vs severe
- **3A only, latency calm** → clear inject / observe; do not Approve just for mild flaps.
